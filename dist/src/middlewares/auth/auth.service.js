...
let AuthMiddlewareService = class AuthMiddlewareService {
    constructor(authMiddlewareRepository) {
        this.authMiddlewareRepository = authMiddlewareRepository;
    }
    getUserById(userId) {
        return this.authMiddlewareRepository.getUserById(userId);
    }
};
AuthMiddlewareService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [auth_repository_1.AuthMiddlewareRepository])
