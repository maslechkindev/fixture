...
exports.AppleSSORepository = void 0;
...
let AppleSSORepository = class AppleSSORepository {
    constructor(knex) {
        this.knex = knex;
    }
    getAccountById(id) {
        return this.knex.first().from('apple_accounts').where({ id });
    }
    async saveUserAndCreateAccount(transactionManager, userData, appleAccountId) {
        ...
        try {
            ...
            await conn('apple_accounts').insert({
                id: appleAccountId,
                userId: user.id,
            });
            return user;
...
AppleSSORepository = __decorate([
    __param(0, (0, knex_1.InjectKnex)()),
    __metadata("design:paramtypes", [Function])
], AppleSSORepository);
exports.AppleSSORepository = AppleSSORepository;
//# sourceMappingURL=apple.repository.js.map