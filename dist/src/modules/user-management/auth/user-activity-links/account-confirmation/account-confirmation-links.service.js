...
exports.AccountConfirmationLinksService = void 0;
...
let AccountConfirmationLinksService = class AccountConfirmationLinksService {
    constructor(firebaseDynamicLinksService) {
        this.firebaseDynamicLinksService = firebaseDynamicLinksService;
    }
    async createConfirmationLink(token) {
        const linkToSend = `${LINK_PREFIX}auth/registration/confirmation/link/${token}`;
...
AccountConfirmationLinksService = __decorate([
...
], AccountConfirmationLinksService);
exports.AccountConfirmationLinksService = AccountConfirmationLinksService;
//# sourceMappingURL=account-confirmation-links.service.js.map